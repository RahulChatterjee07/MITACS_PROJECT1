...
stimulus_event {
picture { 
box { height = 1; width = 150; color = 153, 255, 153; } moving_bar;#moving_bar's height will change based on the applied force.
x = 0; y = 0;
...
stimulus_event {
picture { 
box { height = 10; width = 350; color = 255,0,0; } rest_bar;# rest_box is shown during the rest time and the subject don't need to apply force at that time
x = 0; y = 0;
...
string input2 = system_keyboard.get_input( my_pic5, my_text2, "" );
	...
	begin;
            ...
            begin;
                 ...
                 moving_bar.set_height(MVC2*abs(((joy.y() - joyoffset)-joyval)) );
						...
						ofile.print(abs(joy.y() - joyoffset)) ;
						ofile.print("\t");
						ofile.print("\t");
						ofile.print("\t");
						ofile.print(j);
...
begin;
            ...
            begin;
                 ...
                 my_pic1.set_part_y( 2, 200);
						ofile.print(abs(joy.x() - joyoffset)) ;
						ofile.print("\t");
						ofile.print("\t");
						ofile.print("\t");
						ofile.print(j);
